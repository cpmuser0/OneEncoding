# This Makefile is for the OneEncoding::CORE extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/OneEncoding/CORE.pm]
#     AUTHOR => [q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[OneEncoding::CORE]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/OneEncoding/CORE.pm]
...
MAKE = c:\PROGRA~2\MICROS~1.0\VC\BIN\nmake.exe
FULLEXT = OneEncoding\CORE
BASEEXT = CORE
PARENT_NAME = OneEncoding
DLBASE = $(BASEEXT)
VERSION_FROM = lib/OneEncoding/CORE.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/OneEncoding.pm \
	lib/OneEncoding/CORE.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\OneEncoding
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\OneEncoding
...
TO_INST_PM = lib/OneEncoding.pm \
	lib/OneEncoding/CORE.pm

PM_TO_BLIB = lib/OneEncoding.pm \
	blib\lib\OneEncoding.pm \
	lib/OneEncoding/CORE.pm \
	blib\lib\OneEncoding\CORE.pm
...
DISTNAME = OneEncoding-CORE
DISTVNAME = OneEncoding-CORE-0.02
...
CORE.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"OneEncoding::CORE\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/OneEncoding.pm $(INST_MAN3DIR)\OneEncoding.$(MAN3EXT) \
	  lib/OneEncoding/CORE.pm $(INST_MAN3DIR)\OneEncoding.CORE.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name: OneEncoding-CORE" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"OneEncoding-CORE\"," >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/OneEncoding.pm blib\lib\OneEncoding.pm \
	  lib/OneEncoding/CORE.pm blib\lib\OneEncoding\CORE.pm 
